...
class AES
{
	...
	public function enkripsi($input)
	{
	...
	public function dekripsi($input)
	{
	...
	public function AddRoundKey($data)
	{
	...
	public function MixColumns($data)
	{
	...
	public function InvSubByte($data)
	{
	...
	public function InvShiftRow($data)
	{
	...
	public function InvMixColumns($data)
	{
	...
	public function rotword($w, $row, $col)
	{
		return (($row == 0) ? $w[3][$col] : $w[$row - 1][$col]);
	}

	public function subword($byte)
	{
